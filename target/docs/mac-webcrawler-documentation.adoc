...
| Save Website Text to File a| Boolean |  |  +++false+++ | {nbsp}
| Save As Separate Files a| Boolean |  |  +++false+++ | {nbsp}
| Download Location a| String |  |  | {nbsp}
...
[[Get-website-links]]
=== Get Website Links
`<mac-web-crawler:get-website-links>`
...
|======================
| Name | Type | Description | Default Value | Required
| Results a| Array of Object |  |  | *x*{nbsp}
| Download Path a| String |  |  | *x*{nbsp}
|======================
